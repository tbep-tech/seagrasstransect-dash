...
Similarly, species can be added or removed from the right plot by changing the selection. Below, Halodule is selected and ready to be removed by hitting the backspace key on your keyboard. Caulerpa (attached macroalgae), Dapis (cyanobacteria), and Chaetomorpha (drift green algae) can also be selected, although estimates are unreliable prior to 2021.
...
fillCol(flex = c(0.1, 1),
  fillRow(
    ...
    sliderInput(inputId = 'yrssel1', label = 'Select year range:', min = 1998, max = 2025, value = c(1998, 2025), step = 1, sep = '', width = '90%')
  ),
...
fillCol(flex = c(0.1, 1),
  fillRow(
    ...
    sliderInput(inputId = 'yrssel2', label = 'Select year range:', min = 1998, max = 2025, value = c(1998, 2025), step = 1, sep = '', width = '90%')
  ),
  fillCol(flex = c(1, 1),
