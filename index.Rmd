...
fillCol(flex = c(0.1, 1),
  fillRow(
    ...
    sliderInput(inputId = 'yrssel1', label = 'Select year range:', min = 1998, max = 2023, value = c(1998, 2023), step = 1, sep = '', width = '90%')
  ),
...
fillCol(flex = c(0.1, 1),
  fillRow(
    ...
    sliderInput(inputId = 'yrssel2', label = 'Select year range:', min = 1998, max = 2023, value = c(1998, 2023), step = 1, sep = '', width = '90%')
  ),
  fillCol(flex = c(1, 1),
